            ...
            >
              <Stack paddingTop={2} spacing={2}>
                ...
                <Typography variant="body1">
                  The patient has received a first-time diagnosis of metastatic
                  melanoma with brain metastasis.
                </Typography>
                <Typography variant="body1">
                  Please try to find 10 relevant articles for possible
                  treatments using this search engine.
                </Typography>
                ...
                >
<Box>
                    <Box >Number of relevant articles: {relevanceCount}</Box>
                      <Button variant="outlined" sx={{marginTop:2}} type="submit">Next Patient</Button>
                       </Box>
                </form>
              </Stack>
            </Container>
          ...
          >
            ...
            >
              <Stack paddingTop={2} spacing={2}>
                ...
                <Typography variant="body1">
                  The patient diagnosed with Stage III basal cell carcinoma.
                </Typography>
                <Typography variant="body1">
                  Please try to find 10 relevant articles for possible
                  treatments using this search engine.
                 ...
                 <ListItem style={{display:"none"}}>
                  ...
                  <Box>
                  <Box >Number of relevant articles: {relevanceCount}</Box>
                    <Button variant="outlined"  sx={{marginTop:2}}  type="submit">Next</Button>
                  </Box>
              </Stack>
            </form>
          </Container>
